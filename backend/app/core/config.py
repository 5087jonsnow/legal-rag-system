...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql://legal_admin:changeme_in_production@localhost:5432/legal_rag"
    ...
    DEFAULT_LLM_MODEL: str = "llama-3.3-70b-versatile"  # ← ONLY CHANGE: Fixed model
...
def validate_settings():
    ...
    if settings.USE_RERANKING and settings.RERANKING_MODEL == "cohere" and not settings.COHERE_API_KEY:
        errors.append("COHERE_API_KEY required when using Cohere reranking")
